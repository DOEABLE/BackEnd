...
public class BookStoreManager {
    ...
    public void main(String[] args) {
        ...
        while (true) {
            ...
            //int menu = scanner.nextInt();  // 메뉴 번호 입력 받기
            ...
            switch (menu) {
                ...
                case 6 -> {
//                    User currentUser = manager.getUserInfo(user);
    ...
    // 메서드 1: 보유 도서 정보를 초기화하여 저장하는 메서드
    public void initializeBooks() {
        ...
        books.add(new Book("ISBN3456", "쥐덫", 27000, "애거서 크리스티", "폭설 속에 갇힌 몽스웰 여관-네명의 손님과 주인 부부, 그리고 한 명의 형사", "추리소설", new Date()));
    }


    // 메서드 2: 사용자 정보를 입력받는 메서드
    ...
    public void printAllBooks() {
        ...
        for (Book book : books) {
            System.out.println(book);  // Book 객체의 toString이 호출됨
        }
    }
